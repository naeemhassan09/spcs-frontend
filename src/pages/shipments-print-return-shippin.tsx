...
import styles from "./shipments-print-return-shippin.module.css";

const ShipmentsPrintReturnShippin: FunctionComponent = () => {
  ...
  return (
    <>
      <div className={styles.shipmentsPrintReturnShippin}>
        ...
        <div className={styles.printReturnShippingLabelWrapper}>
          <b className={styles.printReturnShipping}>
            Print Return Shipping Label
          </b>
        </div>
        <div className={styles.typeShipmentBarcodeWrapper}>
          <b className={styles.printReturnShipping}>Type Shipment Barcode</b>
        </div>
...
export default ShipmentsPrintReturnShippin;
