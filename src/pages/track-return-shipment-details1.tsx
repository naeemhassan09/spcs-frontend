...
import styles from "./track-return-shipment-details1.module.css";

const TrackReturnShipmentDetails1: FunctionComponent = () => {
          ...
          <div className={styles.frameParent1}>
            <div className={styles.frameParent5}>
              <div className={styles.groupParent}>
                <div className={styles.ellipseParent}>
                  <div className={styles.groupChild} />
                  <img className={styles.doneIcon} alt="" src="/done1@2x.png" />
                </div>
                <div className={styles.bookingCreated}>
                  <p className={styles.row}>Booking</p>
                  <p className={styles.row}>Created</p>
...
export default TrackReturnShipmentDetails1;
