...
import styles from "./track-return-shipment-details.module.css";

const TrackReturnShipmentDetails: FunctionComponent = () => {
  ...
  return (
    <>
      <div className={styles.trackReturnShipmentDetails}>
        ...
        <div className={styles.scanOrEnterTheBarcodeToVWrapper}>
          <div className={styles.scanOrEnterContainer}>
            <p className={styles.scanOr}>
              Scan Or Enter The Barcode To View Return Shipment Details
            </p>
        ...
        <div className={styles.content1}>
          <div className={styles.frameContainer}>
            ...
            <Link
              ...
              to="/track-return-shipment-details"
            >
...
export default TrackReturnShipmentDetails;
