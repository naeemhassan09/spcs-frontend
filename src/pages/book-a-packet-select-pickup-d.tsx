...
import styles from "./book-a-packet-select-pickup-d.module.css";

const BookAPacketSelectPickupD: FunctionComponent = () => {
  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDateFns}>
      <>
        <div className={styles.bookAPacketSelectPickupD}>
          ...
          <div className={styles.selectPickedUpDateTimeWrapper}>
            <b
              className={styles.selectPickedUp}
            >{`Select  picked Up Date & Time`}</b>
          </div>
          <div className={styles.content}>
            <div className={styles.frameParent}>
              <div className={styles.shippingFromNameJohnDoeWrapper}>
                <div className={styles.selectPickedUp}>
          ...
          <div className={styles.content1}>
            <div className={styles.bookAPacket1}>
              <div className={styles.yourParcelOr}>
                Your Parcel or Packet must be ready when courier guy is come
              </div>
              <div className={styles.frameDiv}>
                <div className={styles.frameWrapper}>
                  <div className={styles.pickupDateParent}>
                    <div className={styles.pickupDate}>Pickup Date</div>
                ...
                <div className={styles.frameWrapper}>
                  <div className={styles.pickupDateParent}>
                    <div className={styles.pickupDate}>Time</div>
                    <div className={styles.dateFromWrapper}>
                      <div className={styles.dateFrom}>
                        <TimePicker
              ...
              <div className={styles.frameParent1}>
                <div className={styles.iWantToPickupMyParcelOnParent}>
                  <div
                    className={styles.iWantTo}
                  >{`I want to Pickup my parcel on `}</div>
                  <img className={styles.infoIcon} alt="" src="/info@2x.png" />
                </div>
                <div className={styles.selectedPickupDateTimeWrapper}>
                  <div
                    className={styles.pickupDate}
                  >{`Selected Pickup Date & Time : `}</div>
                </div>
                <div className={styles.pickupCharges10Wrapper}>
...
export default BookAPacketSelectPickupD;
