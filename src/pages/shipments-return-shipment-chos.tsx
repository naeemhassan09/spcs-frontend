...
import styles from "./shipments-return-shipment-chos.module.css";

const ShipmentsReturnShipmentChos: FunctionComponent = () => {
  ...
  return (
    <>
      <div className={styles.shipmentsReturnShipmentChos}>
        ...
        <div className={styles.content1}>
          <div className={styles.frameGroup}>
            ...
            <Link
              className={styles.backWrapper}
              to="/shipments-return-shipment-select-courier"
            >
...
export default ShipmentsReturnShipmentChos;
