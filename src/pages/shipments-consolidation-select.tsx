...
import styles from "./shipments-consolidation-select.module.css";

const ShipmentsConsolidationSelect: FunctionComponent = () => {
  ...
  return (
    <>
      <div className={styles.shipmentsConsolidationSelect}>
        ...
        <div className={styles.selectCourierAndAssignToSWrapper}>
          <b
            className={styles.selectCourierAnd}
          >{`Select Courier and Assign To Selected Shipment `}</b>
        </div>
...
export default ShipmentsConsolidationSelect;
